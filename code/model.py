...
# Bert Text2Image Encoder-Decoder
class BERT_ENCODER(nn.Module):
    def __init__(self, bert_path = cfg.BERT_PATH):
...
class D_NET32(nn.Module):
    ...
    def forward(self, x_var):
        x_code4 = self.img_code_s8(x_var)  # 4 x 4 x 4df
        x_code4 = self.img_code_s8_1(x_code4)  # 4 x 4 x 8df
        return x_code4
